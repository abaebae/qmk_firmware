...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [0] = LAYOUT( \
                ...
                KC_LCTL,      KC_LALT,    KC_RALT,       LT(1,KC_NO),   KC_LGUI,    KC_SPC,     KC_NO,                  KC_NO,      KC_ENT,     KC_BSPC,    KC_DEL,     KC_RALT,    KC_RGUI,    KC_RCTL  \
                 ),
   [1] = LAYOUT( \
                ...
                KC_LCTL,      KC_LALT,    KC_NO,         KC_TRNS,       KC_LGUI,    KC_SPC,     KC_NO,                  KC_NO,      KC_ENT,     KC_P0,      KC_PDOT,    KC_NO,      KC_EQL,     KC_RCTL  \
                 )
};
