...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [1] = LAYOUT( \
                ...
                KC_TAB,       KC_NO,      KC_UP,      KC_NO,         KC_NO,      KC_NO,      KC_LBRC,                KC_RBRC,    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_UP,      KC_NO,   \
                KC_NO,        KC_LEFT,    KC_DOWN,    KC_RGHT,       KC_RGHT,    KC_NO,      KC_NO,                  KC_NO,      KC_HOME,    KC_END,     KC_PGUP,    KC_PGDN,    KC_NO,      KC_NO,   \
                KC_LSFT,      KC_NO,      KC_NO,      KC_NO,         KC_NO,      KC_LEFT,    KC_NO,                  KC_NO,      KC_DOWN,    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_RSFT, \
                KC_LCTL,      KC_LGUI,    KC_NO,      KC_TRNS,       KC_LALT,    KC_SPC,     KC_NO,                  KC_NO,      KC_ENT,     KC_BSPC,    KC_DEL,     KC_RALT,    KC_RGUI,    KC_RCTL  \
                 )
};
