...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [1] = LAYOUT( \
                ...
                KC_TAB,       KC_NO,      KC_UP,      KC_NO,         KC_NO,      KC_NO,      KC_LPRN,                KC_RPRN,    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,   \
                KC_NO,        KC_LEFT,    KC_DOWN,    KC_RGHT,       KC_NO,      KC_NO,      KC_NO,                  KC_NO,      KC_HOME,    KC_END,     KC_PGUP,    KC_PGDN,    KC_NO,      KC_NO,   \
