...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [1] = LAYOUT( \
                ...
                KC_TAB,       KC_NO,      KC_NO,      KC_END,        KC_NO,      KC_NO,      KC_LBRC,                KC_RBRC,    KC_PSLS,    KC_P7,      KC_P8,      KC_P9,      KC_UP,      KC_NO,   \
                KC_NO,        KC_HOME,    KC_NO,      KC_NO,         KC_RGHT,    KC_NO,      KC_NO,                  KC_NO,      KC_PAST,    KC_P4,      KC_P5,      KC_P6,      KC_PPLS,    KC_NO,   \
                KC_LSFT,      KC_NO,      KC_NO,      KC_NO,         KC_NO,      KC_LEFT,    KC_NO,                  KC_NO,      KC_DOWN,    KC_P1,      KC_P2,      KC_P5,      KC_PEQL,    KC_RSFT, \
                KC_LCTL,      KC_LGUI,    KC_NO,      KC_TRNS,       KC_LALT,    KC_SPC,     KC_NO,                  KC_NO,      KC_ENT,     KC_P0,      KC_PDOT,    KC_PCMM,    KC_PMNS,    KC_RCTL  \
                 )
};
